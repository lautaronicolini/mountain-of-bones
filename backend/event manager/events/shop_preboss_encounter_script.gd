...
func _ready():
	...
	description = "Al avanzar por la cueva ves la puerta 
	de una extraña tienda. 
	El felpudo tiene una inscripcion de 
	bienvenida y el calor dentro del 
	recinto te incita a entrar."
...
func trigger_shop_scene():
	...
	shop.stock = [PotionOfLife.new(), CrownOfFire.new()]
