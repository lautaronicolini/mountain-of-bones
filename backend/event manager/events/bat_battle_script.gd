...
func _ready():
	type = "Bat Battle"
	description = "Al avanzar por el oscuro y húmedo
camino, sentís un aleteo seguido de un
agudo chirrido. Te ataca un murciélago."
...
func trigger_battle_scene():
	...
	battle_scene.set_battle(character, Bat.new())
